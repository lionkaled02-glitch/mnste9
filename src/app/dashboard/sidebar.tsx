 ...
 * ============================================================================
 *  ثمانية روابط (المرحلة 9 — أُضيف رابط العقود) مع إبراز الرابط النشط عبر
 *  usePathname: نظرة عامة / المشاريع / العروض / العقود / المحفظة / الرسائل /
 *  الملف الشخصي / الإعدادات.
 *
 *  القاعدة الذهبية (المرحلة 8) — رابط «توثيق الهوية»:
 *   يُعرض للمستقلين فقط (role === 'freelancer') بعد «الإعدادات».
 *
 *  استجابة الشاشات:
...
/** عناصر القائمة — بالترتيب المحدد في مواصفة المرحلة (8 روابط بعد إضافة العقود) */
