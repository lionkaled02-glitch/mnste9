 ...
 *   الإعدادات.
 *
 *  ملاحظة موثّقة — المسارات المفعّلة والقادمة:
 *   المفعّلة: نظرة عامة، الملف الشخصي (/dashboard/profile)، الإعدادات
 *   (/dashboard/settings). والروابط الأربعة المتبقية (projects/proposals/
 *   wallet/messages) تشير إلى صفحات تُبنى في مراحل قادمة؛ بنية الروابط
 *   مثبّتة الآن كي لا تتغير لاحقاً.
 *
 *  استجابة الشاشات:
